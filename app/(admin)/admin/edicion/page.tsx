    ...
    <section className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          Desde aquí puedes crear, editar y archivar sabores del catálogo real que consume la web pública. Los cambios
          afectan a la home, al listado de productos y a las fichas individuales.
        </p>
      </div>

      <CakeCatalogEditor initialFlavors={flavors} initialArchivedFlavors={archivedFlavors} />
    </section>
  )
}
