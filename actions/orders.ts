...
const ORDER_SEARCH_SELECT =
  "id, delivery_date, status, customer_name, customer_email, phone, notes, created_at, cancelled_at, cancelled_reason, order_items(type, flavor, qty)"
...
export async function searchOrders(query: string) {
  try {
    ...
    const phoneQuery = normalizeOrderSearchPhone(textQuery)
